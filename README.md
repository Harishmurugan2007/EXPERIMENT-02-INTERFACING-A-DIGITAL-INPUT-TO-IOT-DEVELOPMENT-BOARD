...
Interfacing a digital Input (ir pair) with ARM microcontroller based IOT development is executed and the results are verified.](https://github.com/Harishmurugan2007/EXPERIMENT-01-INTERFACING-A-DIGITAL-OUTPUT-TO-IOT-DEVELOPMENT-BOARD.git)
